    ...
    <div class="col-md-6 grid-margin stretch-card">
      <div class="card">
        <div class="card-body pb-0">
          <h6 class="card-title">Term & Condition</h6>
            
            <form class="forms-sample mb-4" action="{{url('admin/updateTerm')}}" method="post" enctype="multipart/form-data" >
              @csrf
             
              <div class="form-group">
                      <label for="exampleTextarea1">Term & Condition</label>
