            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-6 grid-margin">
                  <div class="card">
                    <div class="card-body">
                      <form class="forms-sample" action="{{url('admin/createReports')}}" method="post" enctype="multipart/form-data">
                         @csrf
                  ...
                  <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="successfull_from" id="exampleInputEmail1" placeholder="" required="">  
                  </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                         ...
                         <div class="form-group">
                          ...
                          <input type="text" name="successfull_to" class="form-control" id="exampleInputPassword1" placeholder="Enter Name" required="">
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Satisfactory From </label>
                          <input type="text" class="form-control" name="satisfactory_from" id="exampleInputEmail1" placeholder="" required="">  
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Satisfactory To</label>
                          <input type="text" class="form-control" name="satisfactory_to" id="exampleInputEmail1" placeholder="" required="">  
                        </div>

                        <div class="form-group">
                          <label for="exampleInputEmail1">Not Acceptable From </label>
                          <input type="text" class="form-control" name="acceptable_from" id="exampleInputEmail1" placeholder="" required="">  
                        </div> 

                        <div class="form-group">
                          <label for="exampleInputEmail1">Not Acceptable To </label>
                          <input type="text" class="form-control" name="acceptable_to" id="exampleInputEmail1" placeholder="" required="">  
                        </div>
